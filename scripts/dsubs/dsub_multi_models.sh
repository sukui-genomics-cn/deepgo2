#!/bin/bash
#DSUB -n DeepGO_MultiModel
#DSUB -A root.project.P24Z10200N0983
#DSUB -R 'cpu=64;gpu=1;mem=10000'
#DSUB -N 1
#DSUB -eo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/deepgo2/outputs/logs/DeepGO_MultiModel.%J.%I.err
#DSUB -oo /home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/deepgo2/outputs/logs/DeepGO_MultiModel.%J.%I.out

## must Edit DSUB -oo & -eo file path

## Set scripts
RANK_SCRIPT="./scripts/tasks/multi_models.sh"
